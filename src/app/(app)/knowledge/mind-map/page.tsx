          ...
          <div className="flex h-full flex-col items-center justify-center gap-4 text-center">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                ...
                className="flex items-center gap-1.5 border border-border bg-background px-4 py-2 text-sm font-medium text-foreground hover:bg-surface transition-colors"
              >
